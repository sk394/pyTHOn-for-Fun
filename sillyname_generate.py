...
def main():
    ...
    print("Welcome to the Daaata ' Naam rakhne Baje")
    print("A name like Ghamndilal")
 ...
 'Sugar-Gold', 'Swackhamer', 'Tippins', 'Turnipseed', 'Vinaigrette', 'Walkingstick', 'Wallbanger', 'Weewax', 'Weiners', 
